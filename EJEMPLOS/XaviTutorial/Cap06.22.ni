...
[ejemplo de librería Patrollers; asigna rutas predefinidas para los personajes]
...
La chica robot is a female in the Centro. La chica is a patroller. The chica is  RoomLed.The RoomTable of the chica is the Table of de_tiendas.
...
[Lo siguiente es para el caso de suejeto follower]
[The chica is a patroller. The chica is following.

Every turn: if the chica is in location, deactivate the chica.]
