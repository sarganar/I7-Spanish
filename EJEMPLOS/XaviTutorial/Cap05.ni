...
El mapa del tesoro is carried by player. The mapa del tesoro can be seco or mojado. The mapa del tesoro is seco. The description is "¡Parece un mapa auténtico! En el mapa hay varias anotaciones: un dibujo, una cruz, un símbolo y un escrito. Tal vez si logro descifrarlo todo encontraré un tesoro... ¡y seré rico! ¡Ja!". 

Understand "examina [text]" as examining as a book when the player carries the mapa.

Examining as a book is an action applying to one topic. 

Carry out examining as a book: 
	say "No encuentras nada relativo a eso en el mapa." 

Instead of examining as a book a topic listed in the Table of Clues: 
	say "[if the mapa del tesoro is seco]Bajo [the topic understood], está manuscrito lo siguiente: [description entry].[otherwise]El mapa está mojado e inservible. ¡Deberías haber tenido más cuidado al cruzar a nado la costa!". 

Table of Clues
topic	title	description 
"dibujo/isla"	"el dibujo de la isla"	"Hay varias islas en este archipiélago del infierno, pero la isla del tesoro es la que está más al norte, y la más peligrosa..."
"cruz"	"una cruz en el mapa"	"El tesoro se encontró en el barco 'Guadalupe', que fue atacado por los salvajes... si encuentro los restos del barco, encontraré la isla"
"simbolo/tribal"	"un símbolo tribal"	"Este símbolo es la representación del dios de los salvajes que custodian el tesoro, tal vez si me lo tatuara creerían que soy su dios..."
"escrito"	"un escrito"	"Romualdo Guimaraes, que murió persiguiendo un sueño. Si encuentras este mapa, encontrarás el tesoro o tu muerte."
...
The riachuelo is fixed in place in Bosque2. The initial appearance is "Un pequeño riachuelo cruza serpenteando el bosque.". The description is "El agua del pequeño riachuelo fluye limpia y clara.". Understand "rio", "agua", "caudal" and "fondo" as the riachuelo.
...
The aula (f) is a room. The printed name of the aula is "Aula de historia". The description is "Estás en clase de historia. Todos tus compañeros te miran divertidos al ver que te has vuelto a dormir en plena clase.".
...
Understand "duermete"  as sleeping.
...
Profesor is a man in the aula. "El profesor Antonio te mira con severidad.". The description is "Tiene un gran parecido con el náufrago de tu sueño.". Understand "Antonio" as the profesor.
...
Topic	Muse
"hola/explicacion/pregunta"	"'¡Te he hecho una pregunta! ¿Qué es lo que estaba explicando?'"
"colonizacion"	"'Exacto, Sebastián... veo que por lo menos sabía a qué venías a clase. ¿Quién fue Colón?'"
"cristobal/colon" or "cristobal colon"	"'Te he hecho una pregunta, ¿quién fue Colón?'"
"descubrimiento/descubridor"	"'Colón fue un descubridor, Sebastián... ¿y quién fue Hernán Cortés?'"
"conquistador/hernan cortes"	"'Hernán Cortés fue el que conquistó el imperio azteca, lo que hoy es México.'"
"no se" or "no lo se" or "ayuda"	"'¿Cómo que no sabes? ¡Hablamos del descubrimiento de América!'"
"america/continente"	"'Sí, América, lo que descubrió Colón ¿te suena el nombre, Sebastián?'" 
